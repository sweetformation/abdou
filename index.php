    ...
    <div id="content">
        ...
        <div id="right">
            ...
            <div class="services">
                ...
                <span class="tagline">Vous ne faites que gonfler, voler, manger, rire, dormir. Le reste, je m'en occupe...</span><br /><br /></p>
                <div class="servicesimg">
                    <div class="transport1">
                        <div class="transport"></div>
                        <div class="tddesc">
                            <h3>Transport</h3>
                            Transfert de et vers l'aéroport, navettes entre l'attéro et le déco, courses locales avant le départ...
                        </div>
                    </div>
            ...
            <div class="services">
               ...
               <p>2 circuits sont plus souvent pratiqués, car ils offrent une grande variété de sites intéressants. Cependant, je suis à votre disposition pour vous proposer d'autres destinations selon vos souhaits. Et, en cours de séjour, si la météo nous y oblige, nous pourrons bien sur modifier le parcours pour aller là où ça vole !<br /><br /></p>
                ...
                <br />
                <div class="p">
                    <p class="tik">Disponible de septembre à janvier (de février à mai, contactez <a href="http://www.lesgensdair.com/maroc.htm" title="Voyage de parapente au Maroc" target="_blank">Les Gens d'Air</a>).</p>
                    <p class="tik">Pour voler avec moi, vous devez être un pilote breveté.</p>
                    <p class="tik">Avant le départ, vous devez impérativement avoir remplir les conditions d'autorisation de vol au Maroc.</p>
                </div>
            </div>
